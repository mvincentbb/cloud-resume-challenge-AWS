                ...
                <article id="31830723-b81e-4cea-af8e-16ddc19023bd" className="page sans">
                    ...
                    <div className="page-body">
                        <h3 id="a4a95dcc-2fee-411a-84cd-38ea5cec4ac3" className="">
                            <strong>Web Developer | Devops | Cloud Engineer</strong>
                        </h3>
                        ...
                        <div id="140e0b20-b1f4-41d7-96d9-ea380d1d0bff" className="column-list">
                            ...
                            >
                                ...
                                <div className="indented">
                                    ...
                                    >
                                        <li style={{ listStyleType: "disc" }}>
                                            I focus on cloud engineering using AWS, Docker, Kubernetes for
                                            my work
                                        </li>
                                    </ul>
                                    <ul
                            ...
                            >
                                ...
                                <ul
                                    ...
                                    className="bulleted-list"
                                >
                                    <li style={{ listStyleType: "disc" }}>Linux, Bash, Shell</li>
                                </ul>
                                <ul
                                ...
                                <p id="331153b0-5072-41ee-ad19-ceda0127bdbf" className=""></p>
